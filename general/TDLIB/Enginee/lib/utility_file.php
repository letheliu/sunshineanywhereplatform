...
function attach_sub_dir( )
{
				...
				{
								$SCRIPT = substr( $_SERVER['SCRIPT_NAME'], 9 );
				}
				else if ( substr( $_SERVER['SCRIPT_NAME'], 0, 5 ) == "/pda/" )
				{
								$SCRIPT = substr( $_SERVER['SCRIPT_NAME'], 5 );
				}
				else
				{
								$SCRIPT = "";
				}
				if ( substr( $SCRIPT, 0, 7 ) == "system/" )
				{
