...
<?
	...
	for($i=0;$i<sizeof($sunshine_teacher_class_array);$i++)		{
		...
		print "
		<tr class=TableData>
		<td align=center onclick=\"javascript:parent.user.location='user.php?班号=$FieldValue&TO_ID=".$_GET['TO_ID']."&TO_NAME=".$_GET['TO_NAME']."&FORM_NAME=".$_GET['FORM_NAME']."';parent.control.location='control.php?班号=$FieldValue&TO_ID=".$_GET['TO_ID']."&TO_NAME=".$_GET['TO_NAME']."&FORM_NAME=".$_GET['FORM_NAME']."';\" style=\"cursor:pointer\">".$FieldValue."</td>
		</tr>
		";
	}
