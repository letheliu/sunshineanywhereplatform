...
if($_GET['班号']!="")		{
	$AddSql = " and 班号='".$_GET['班号']."' and 学生状态='正常状态'";
}
...
echo "<table class=\"TableBlock trHover\" width=\"100%\">\r\n<tr class=\"TableHeader\">\r\n  <td align=\"center\" nowrap><b>学生列表[".$_GET['班号']."]</b></td>\r\n</tr>\r\n\r\n";

$sql = "select 学号,姓名 from edu_student,edu_banji where edu_student.班号=edu_banji.班级名称 and 毕业时间<'$当前时间' $AddSql order by 学号,姓名";
$rs = $db->CacheSelectLimit(15,$sql,120,0);
$rs_a = $rs->GetArray();
for($i=0;$i<sizeof($rs_a);$i++)			{
	$姓名 = $rs_a[$i]['姓名'];
	$学号 = $rs_a[$i]['学号'];

	echo "\r\n<tr class=\"TableData\">\r\n  <td class=\"menulines\" title=\"".$姓名."[".$学号."][".$_GET['班号']."]\" align=\"center\" onclick=\"javascript:add_user('";
	echo $学号;
	echo "','";
	echo "".$姓名."";
