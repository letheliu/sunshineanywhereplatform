...
$TARGET_ARRAY = $PRIVATE_SYSTEM['在线报名考试'];
...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_ZAIXIANKAOSHI_MENU.php" frameborder="0">
    <frame name="menu_main_frame" scrolling="auto" src="<?=$fileName?>" frameborder="0">
</frameset><?
/*
	版权归属:郑州单点科技软件有限公司;
	联系方式:0371-69663266;
