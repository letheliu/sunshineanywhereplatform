...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="main_shenqing_menu.php" frameborder="0">
    <frame name="main_frame2" scrolling="auto" src="crm_kaipiao_sq_newai.php" frameborder="0">
