...
<frameset rows="30,*"  cols="*" frameborder="0" border="0" framespacing="0" id="frame1">
    <frame name="file_title" scrolling="no" noresize src="MAIN_CRM_DEPT_MENU.php" frameborder="0">
    <frame name="main_frame" scrolling="auto" src="crm_clendar_dept.php" frameborder="0">
</frameset><?
/*
	版权归属:郑州单点科技软件有限公司;
	联系方式:0371-69663266;
