...
<script type="text/javascript" src="/inc/js/module.js"></script>
...
<table class="TableBlock" width="500" align="center">
  <form action="crm_mytable_set.php?check=upd"  method="post" name="form1">
   ...
   <tr class="TableData">
    <td>左侧栏目宽度：</td>
    <td><input type="text" name="left_width" class="BigInput" size="5" <?if($左侧栏目宽度 != ''){ echo "value='".$左侧栏目宽度."'";}else{echo "value=60";}?>>%</td>
   </tr>
   <tr class="TableData">
    <td>各模块显示行数：</td>
