...
function bookstatus_Value($fieldvalue,$fields,$i)		{
	...
	if($所属状态!="图书已分配"&&$所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"bookssetout_newai.php?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&所属部门=$所属部门&所属部门_NAME=DEPT_NAME&所属部门_disabled=disabled")."\">借领</a> ";

	if($所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"bookstuihuan_newai.php
?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&所属部门=$所属部门&所属部门_NAME=DEPT_NAME&所属部门_disabled=disabled")."\">归还</a> ";
	...
	if($所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"bookssetin_newai.php
?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&所属部门=$所属部门&所属部门_NAME=DEPT_NAME&所属部门_disabled=disabled&采购标识=$采购标识&图书类别=$图书类别")."\">采购</a> ";
	...
	if($所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"bookstiaobo_newai.php
?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&原有所属部门=$所属部门&原有所属部门_NAME=DEPT_NAME&原有所属部门_disabled=disabled")."\">调拨</a> ";
	...
	if($所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"booksdiushi_newai.php?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&所属部门=$所属部门&所属部门_NAME=DEPT_NAME&所属部门_disabled=disabled")."\">丢失</a> ";

	if($所属状态!="图书己报废"&&$所属状态!="图书己丢失") $Text .= "<a class=OrgAdd href=\"bookssetbaofei_newai.php
?".base64_encode("action=add_default&图书编号=$图书编号&图书编号_NAME=图书编号&图书编号_disabled=disabled&图书名称=$图书名称&图书名称_NAME=图书名称&图书名称_disabled=disabled&所属部门=$所属部门&所属部门_NAME=DEPT_NAME&所属部门_disabled=disabled")."\">报废</a>";
	...
	if($所属状态=="图书己报废") $Text .= "<font color=green>该图书己经处于报废状态
	</font>";
	if($所属状态=="图书己丢失") $Text .= "<font color=green>该图书己经处于丢失状态
    </font>";
	$Text .= ")";
