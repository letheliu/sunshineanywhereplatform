...
?>
	...
	&nbsp;
	<Input type="button" name="return" value="导 出" class=SmallButton onClick="location='?action=<?=$_GET['action']?>&pageAction=ExportDataToFile&导出方式=全部&检测类型=<?=$检测类型?>&检测结果=<?=$检测结果?>&是否存在问题=<?=$是否存在问题?>&问题是否解决=<?=$问题是否解决?>';">
