...
for($i=0;$i<sizeof($rs_a);$i++)			{
	$学院代码 = $rs_a[$i]['学院代码'];
	$学院名称 = $rs_a[$i]['学院名称'];
	print "<TreeNode id=\"$学院代码\" text=\"[$学院名称]".$AddInfor."\" href=\"#\" target=\"_self\" img_src=\"images/node_user.gif\" title=\"$学院名称\" Xml=\"inc_banji_tree_biye.php?DEPT_ID=$学院代码&amp;PARA_URL1=&amp;PARA_URL2=$PARA_URL2&amp;PARA_TARGET=$PARA_TARGET&amp;PRIV_NO_FLAG=XI&amp;PARA_ID=&amp;PARA_VALUE=&amp;MANAGE_FLAG=&amp;DIR=$DIR\"/>\r\n";
...
for($i=0;$i<sizeof($rs_a);$i++)			{
	...
	print "<TreeNode id=\"$系代码\" text=\"[$系名称]".$AddInfor."\"  href=\"#\" target=\"_self\"  img_src=\"images/node_user.gif\" title=\"$系名称\" Xml=\"inc_banji_tree_biye.php?DEPT_ID=$系代码&amp;PARA_URL1=&amp;PARA_URL2=$PARA_URL2&amp;PARA_TARGET=$PARA_TARGET&amp;PRIV_NO_FLAG=JIBIE&amp;PARA_ID=&amp;PARA_VALUE=&amp;MANAGE_FLAG=&amp;DIR=$DIR\"/>\r\n";
...
for($i=0;$i<sizeof($rs_a);$i++)			{
	...
	print "<TreeNode id=\"$专业代码\" text=\"[$专业名称]".$AddInfor."\"  href=\"#\" target=\"_self\"  img_src=\"images/node_user.gif\" title=\"$专业名称\" Xml=\"inc_banji_tree_biye.php?DEPT_ID=$专业代码&amp;PARA_URL1=&amp;PARA_URL2=$PARA_URL2&amp;PARA_TARGET=$PARA_TARGET&amp;PRIV_NO_FLAG=BANJI&amp;PARA_ID=&amp;PARA_VALUE=&amp;MANAGE_FLAG=&amp;DIR=$DIR\"/>\r\n";
	//print "<TreeNode id=\"$USER_ID\" text=\"[$系名称]\" href=\"../Interface/$DIR/".$PARA_URL2."?班号=$系名称\" target=\"edu_main\" img_src=\"images/node_user.gif\" title=\"$系名称\"/>\r\n";
}
}
*/
...
for($i=0;$i<sizeof($rs_a);$i++)			{
	...
	$入学年份 = $rs_a[$i]['入学年份'];
	//href=\"../Interface/$DIR/edu_banji_newai.php?所属专业=$专业代码\" target=\"edu_main\"
	print "<TreeNode id=\"$入学年份\" text=\"[$入学年份]".$AddInfor."\"  href=\"#\" target=\"_self\"  img_src=\"images/node_user.gif\" title=\"$入学年份\" Xml=\"inc_banji_tree_biye.php?DEPT_ID=$DEPT_PARENT&amp;PARA_URL1=$入学年份&amp;PARA_URL2=$PARA_URL2&amp;PARA_TARGET=$PARA_TARGET&amp;PRIV_NO_FLAG=BANJI&amp;PARA_ID=&amp;PARA_VALUE=&amp;MANAGE_FLAG=&amp;DIR=$DIR\"/>\r\n";
}
}
...
for($i=0;$i<sizeof($rs_a);$i++)			{
	$班级代码 = $rs_a[$i]['班级代码'];
	$班级名称 = $rs_a[$i]['班级名称'];
	//print "<TreeNode id=\"$班级代码\" text=\"[$班级名称]".$AddInfor."\" href=\"../Interface/$DIR/".$PARA_URL2."?XZB=$班级名称\" target=\"edu_main\" img_src=\"images/node_user.gif\" title=\"$班级名称\" Xml=\"inc_banji_tree_biye.php?DEPT_ID=$班级代码&amp;PARA_URL1=&amp;PARA_URL2=$PARA_URL2&amp;PARA_TARGET=$PARA_TARGET&amp;PRIV_NO_FLAG=0&amp;PARA_ID=&amp;PARA_VALUE=&amp;MANAGE_FLAG=&amp;DIR=$DIR\"/>\r\n";
	print "<TreeNode id=\"$班级代码\" text=\"[$班级名称][$班级代码]\" href=\"../Interface/$DIR/".$PARA_URL2."?".base64_encode("班号=$班级名称")."\" target=\"edu_main\" img_src=\"images/node_user.gif\" title=\"$班级名称\"/>\r\n";
	//print "<TreeNode id=\"$USER_ID\" text=\"[$系名称]\" href=\"../Interface/$DIR/".$PARA_URL2."?班号=$系名称\" target=\"edu_main\" img_src=\"images/node_user.gif\" title=\"$系名称\"/>\r\n";
}
}
...
//班级
$datetime = date("Y-m-d");
$sql = "select 班级代码,班级名称 from edu_banji where 入学年份 = '$DEPT_PARENT' and 毕业时间<='$datetime' order by 班级名称,班级名称";
$rs = $db->Execute($sql);
$rs_a = $rs->GetArray();
//print $DIR;exit;
for($i=0;$i<sizeof($rs_a);$i++)			{
