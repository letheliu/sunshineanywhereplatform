...
//########################################################################
//判断是否为BASE64编码
$isBase64 = isBase64();		//print $isBase64;
//进行_GET变量转换
...
function system_log_input($LOGINACTION,$SQL)		{
	...
	$sql = "insert into system_log values('','$LOGINACTION','$DATETIME','$REMOTE_ADDR','$HTTP_USER_AGENT','$QUERY_STRING','$SCRIPT_NAME','$LOGIN_USER_ID','$SQL');";
	$db->Execute($sql);
	//print $sql;exit;
