...
if($_GET['课程类别']!="")		{
	$AddSql = " where 课程类别='".$_GET['课程类别']."'";

}


echo "<table class=\"TableBlock trHover\" width=\"100%\">\r\n<tr class=\"TableHeader\">\r\n  <td align=\"center\"><b>选择课程</b></td>\r\n</tr>\r\n\r\n";


if($_GET['action']=="SEARCH")	{
	$KEYVALUE = $_GET['KEYVALUE'];
	$AddSql = " where 课程名称 like '%$KEYVALUE%' or 课程代码 like '%$KEYVALUE%' ";
}//print_R($_GET);

//print $AddSql;

$sql = "select 课程类别,课程名称,课程代码 from edu_course $AddSql order by 课程类别,课程名称";
