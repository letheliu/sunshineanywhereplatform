	...
	if(key!=kword.value && kword.value!="")
	{
     key=kword.value;
	   ...
	   if($('search_icon').src.indexOf("/images/quicksearch.gif")>=0)
	   {
	   	   ...
	   	   $('search_icon').onclick=function(){kword.value='按银行账户搜索...';$('search_icon').src="/images/quicksearch.gif";$('search_icon').title="";$('search_icon').onclick=null;};
	   }
  }
...
if($_GET['action']=="SEARCH")	{
	...
	$AddSql = " where 银行名称 like '%$KEYVALUE%'";
}//print_R($_GET);

//print $AddSql;

echo "<table class=\"TableBlock trHover\" width=\"150%\">\r\n<tr class=\"TableHeader\">\r\n  <td align=\"center\"><b>选择银行账号</b></td>\r\n</tr>\r\n\r\n";

$sql = "select * from crm_yinhangzh $AddSql order by 开户行 ";
...
for($i=0;$i<sizeof($rs_a);$i++)			{
	...
	echo "\r\n<tr class=\"TableData\">\r\n  <td class=\"menulines\" align=\"center\" onclick=\"javascript:add_user()\" style=\"cursor:hand\">";
