...
function export_newai_XLS($fields)					{
	...
	if(is_file("../../PHPExcelParser4/WriteExcel/class.writeexcel_workbook.inc.php"))	{
		require_once "../../PHPExcelParser4/WriteExcel/class.writeexcel_workbook.inc.php";
		require_once "../../PHPExcelParser4/WriteExcel/class.writeexcel_worksheet.inc.php";
	}
