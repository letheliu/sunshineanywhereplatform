<?
	...
	*/
	...
	//直接到消息中心页面
	print  "<META HTTP-EQUIV=REFRESH CONTENT='0;URL=../../Framework/calendar_week.php'>";

	exit;

	CRM系统过滤个人权限();

	//数据表模型文件,对应Model目录下面的crm_clendar_newai.ini文件
	//如果是需要复制此模块,则需要修改$parse_filename参数的值,然后对应到Model目录 新文件名_newai.ini文件
	$filetablename		=	'crm_clendar';
	$parse_filename		=	'crm_clendar_person';
