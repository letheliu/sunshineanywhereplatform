...
<TD class=TableData noWrap colspan=\"2\"><INPUT type=\"text\" title='' onkeydown=\"if(event.keyCode==13)event.keyCode=9\" accesskey='6' class=\"SmallStatic\"  maxLength=200 size=\"30\" name=\"数量\" value=\"$数量\" readonly onkeyup=\"value=value.replace(/[^\d]/g,'');DoItInforJinEr();\"  onbeforepaste=\"clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''));DoItInforJinEr();\"  >
...
<input type=\"text\" name=\"金额\" value=\"$金额\" readonly class=\"SmallStatic\" size=\"20\"><BR>(此处由数量和单价自动生成金额)
</TD></TR>
	";
}
