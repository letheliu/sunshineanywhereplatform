...
if($_GET['action']=="")			{
	...
	print "<tr class=TableData><td width=40%>&nbsp;初始化时间:</td><td>&nbsp;<INPUT class=SmallInput maxLength=20  name=开始时间 value=\"".date("Y-m-d",mktime(1,1,1,date('m'),date('d'),date('Y')))."\"  >
	</td></tr>";
...
处理迟到早退分钟数数据();
print_infor("你的数据操作己经成功,请返回<BR><a href='edu_xingzheng_kaoqinmingxi_newai.php?XX=XX&action=init_default&人员用户名=$人员用户名&pageid=1'>点击直接查阅".$行政人员."人员的考勤明细</a>","location='?'","location='?'");;
exit;
}
