...
if($_GET['action']=="init_default"||$_GET['action']=="")					{
	...
	print "
		...
		<tr class=TableHeader><td valign=bottom align=left>行政人员考勤管理 ".$html_etc['edu_xingzheng_kaoqinmingxi']['学期'].":$学期名称</td></tr>
		...
		print "
		<table border=0 class=TableBlock width=100% >
		<tr class=TableHeader><td valign=bottom align=left>行政人员考勤按周次查询 ".$html_etc['edu_xingzheng_kaoqinmingxi']['学期'].":$学期名称</td></tr>
		<tr class=TableData><td valign=bottom align=left>
		<BR>";
